  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#fff',  }}>
      ...
      <View style={{ padding: 25 }}>
        <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#333' }}>Perks of  Gold Membership</Text>
        <Text style={{ fontSize: 15, color: '#666', marginTop: 15 }}>•  Access to all Sportzon venues.</Text>
        <Text style={{ fontSize: 15, color: '#666', marginTop: 5 }}>•  Get Free 30 days extension.</Text>
        <Text style={{ fontSize: 15, color: '#666', marginTop: 5 }}>•  Get 10% off on all Sportzon Merchandise.</Text>
        <Text style={{ fontSize: 15, color: '#666', marginTop: 5 }}>•  Recharge your Credit Wallet and enjoy 10% extra every time!</Text>
        <Text style={{ fontSize: 15, color: '#666', marginTop: 5 }}>•  Get premium goodies and gift vouchers that match the value of Gold Plan.</Text>
