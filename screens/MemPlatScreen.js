...
const SilverMembershipScreen = () => {
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#fff',  }}>
      {/* Header Section */}
      <View style={{ backgroundColor: '#6A5ACD', height:250, padding: 20,  position: 'relative' }}>
       <Text style={{ fontSize: 29, fontWeight: "bold", color: "white",marginTop: 20, marginLeft:7 }}>Platinum</Text>
       ...
       <Text style={{ fontSize: 14, color: '#fff', marginLeft:7 }}> with a Platinum membership plan.</Text>
      ...
      <View style={{ padding: 25 }}>
        <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#333' }}>Perks of  Platinum Membership</Text>
        ...
        <Text style={{ fontSize: 15, color: '#666', marginTop: 5 }}>•  Get premium goodies and gift vouchers that match the value of Platinum Plan.</Text>
